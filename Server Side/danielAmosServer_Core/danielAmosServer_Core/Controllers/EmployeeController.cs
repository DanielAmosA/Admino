...
namespace danielAmosServer_Core.Controllers
{
    ...
    {
        private readonly IEmployeeOrcRead employeeOrcRead;
        private readonly IEmployeeOrcWrite employeeOrcWrite;

        public EmployeeController(IEmployeeOrcRead employeeOrcRead, IEmployeeOrcWrite employeeOrcWrite)
        {
